...
<form method="POST" action="/find_id" id="find_id" style="display:none;">
    <table>
        <!-- 아이디 찾기 폼 -->
        <tr>
            <td>이름</td>
...
<form method="POST" action="/find_password" id="find_password" style="display:none;">
    <table>
        <tr>
            <td>아이디</td>
            <td>
...
function showFindPassword() {
    document.getElementById("find_password").style.display = "block";
